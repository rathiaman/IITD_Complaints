...
public class ParticularHostelComplaint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        complaint_title1 = HostelComplaintDetails.getParticular_hostel_complaint_title();
        complaint_contactinfo1 = HostelComplaintDetails.getParticular_hostel_complaint_contact_info();
        complaint_complainttype1 = HostelComplaintDetails.getParticular_hostel_complaint_complaint_type();
        complaint_status1 = HostelComplaintDetails.getParticular_hostel_complaint_status();
        complaint_description1 = HostelComplaintDetails.getParticular_hostel_complaint_description();
        complaint_id1 = HostelComplaintDetails.getParticular_hostel_complaint_id();
        complaint_Hostel1 = HostelComplaintDetails.getParticular_hostel_complaint_hostel();
        complaint_posted_by_first_name_1 = HostelComplaintDetails.getParticular_hostel_complaint_posted_by_first_name();
        complaint_posted_by_last_name_1 = HostelComplaintDetails.getParticular_hostel_complaint_posted_by_last_name();

        TextView complaint_title = (TextView)findViewById(R.id.particular_hostel_complaint_title_answer);
        TextView complaint_postedby= (TextView)findViewById(R.id.particular_hostel_complaint_posted_by_answer);
       TextView complaint_type =(TextView)findViewById(R.id.particular_hostel_complaint_type_answer);
        TextView complaint_contactinfo =(TextView)findViewById(R.id.particular_hostel_complaint_conatct_info_answer);
        TextView complaint_status =(TextView)findViewById(R.id.particular_hostel_complaint_status_answer);
        TextView complaint_description =(TextView)findViewById(R.id.particular_hostel_complaint_description_answer);
...
///////////////////////////////////////////////////////////////
        ...
        Hostel_post_comment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                submitNewComment();
                Hostel_comment.setText("");
    ...
    public void submitNewComment(){
        ...
        if (post_comment.length() == 0){Toast.makeText(ParticularHostelComplaint.this, "The comment size is zero", Toast.LENGTH_SHORT).show();}
            ...
            StringRequest request = new StringRequest(Request.Method.POST, url,
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(ParticularHostelComplaint.this, "Network Error", Toast.LENGTH_SHORT).show();
...
//////////////////////////////////////////////////////////
    ...
    public void create_complaint_table()
    {
        ...
        TableLayout course_assig_table = (TableLayout) findViewById(R.id.particular_hostel_complaint_comment_table);
