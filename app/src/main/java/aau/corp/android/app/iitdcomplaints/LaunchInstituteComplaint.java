...
public class LaunchInstituteComplaint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        choose_image = (Button) findViewById(R.id.institute_complaint_image_button);
        ...
        upload_image_launch_personal_complaint = (ImageView) findViewById(R.id.imageView_institute_complaint_launch);
        submit = (Button) findViewById(R.id.submit_button_institute_complaint_launch);
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder submit_alert = new AlertDialog.Builder(LaunchInstituteComplaint.this);
    ...
    public void submitNewComplaint(){
        ...
        comment_title_edittext = (EditText)findViewById(R.id.editText_institute_complaint_title);
        description_edittext = (EditText)findViewById(R.id.editText_institute_complaint_description);
        contact_edittext = (EditText)findViewById(R.id.editText_institute_complaint_contact_info);
        ...
        if(comment_title.length() == 0){
            Toast.makeText(LaunchInstituteComplaint.this, "Title Required", Toast.LENGTH_SHORT).show();
        }

        else if(description.length() == 0){
            Toast.makeText(LaunchInstituteComplaint.this, "Description Required", Toast.LENGTH_SHORT).show();
        }

        else if(CheckInput.check_contact_info(contact) == false){
            Toast.makeText(LaunchInstituteComplaint.this, "Invalid 10-digit Contact Info", Toast.LENGTH_SHORT).show();
        }
...
//            ProgressDialog.show(LaunchPersonalComplaint.this,"Uploading...","Please wait...",false,false);
            String url;
            url = "http://" + adder1 + "/complaint_system/create_complaint/institute_complaint.php";
            ...
            StringRequest request = new StringRequest(Request.Method.POST, url,
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(LaunchInstituteComplaint.this, error.toString(), Toast.LENGTH_SHORT).show();
                        }
                    }) {
            ...
            Intent in = new Intent(LaunchInstituteComplaint.this, HomeScreen.class);
            startActivity(in);
            ///loading.hide();
        }
    }
